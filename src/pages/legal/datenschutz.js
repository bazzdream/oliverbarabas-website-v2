    ...
    <Container style={{ padding: "15px" }}>
      ...
      <ol>
        ...
        <li>
          ...
          für die Speicherdauer von 30 Tagen. Nach Ablauf dieser Frist werden
      ...
      <ol>
        ...
        <li>
          ...
          ) sind, wird sichergestellt, dass das europ&auml;ische
        ...
        <li>
          ...
          .<br />
          <br />• <strong>XING</strong> – Diensteanbieter: XING AG,
          ...
          .<br />
          <br />• <strong>LinkedIn</strong> – Diensteanbieter: LinkedIn Ireland
      ...
      <br />
      <br />
      <strong>Stand: 12.01.2020</strong>
      <p>
        Quelle:{" "}
        <a
